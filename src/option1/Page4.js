...
function Page4() {
    return (
        <div className="page4-box overflow-hidden flex justify-center items-center">
            <div className="img w-1/2">
                <img className="cuisine-img w-full"src={cuisine} width="680" alt="Cuisine" />
            </div>
            <div className="cuisine-thibodeau w-1/2 flex flex-col justify-center items-center">
                ...
                <p className="text-justify text-xl w-9/12"> La cuisine de la propriété a été aménagée avec sensibilité, afin
